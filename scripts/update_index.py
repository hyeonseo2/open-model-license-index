...
[![Update Index](https://github.com/hyeonseo2/open-model-license-index/actions/workflows/update.yml/badge.svg)](https://github.com/hyeonseo2/open-model-license-index/actions/workflows/update.yml)
...
:root{
  --bg:#f8fafc; --bg-glass:rgba(255,255,255,0.85);
  --surface:#ffffff; --surface-hover:#f1f5f9;
  --border:rgba(0,0,0,0.06); --border-glow:rgba(99,102,241,0.2);
...
html{font-family:'Inter',system-ui,sans-serif;background:var(--bg);color:var(--text);font-size:14px;}
body{
  min-height:100vh;padding:0;
  background-image:
    radial-gradient(circle at 15% 50%, rgba(99,102,241,0.05), transparent 20%),
    radial-gradient(circle at 85% 30%, rgba(192,132,252,0.05), transparent 20%);
}
...
.hero p{color:var(--text2);font-size:1.1rem;max-width:640px;margin:0 auto;line-height:1.6;font-weight:450;}
.hero .badge{
  display:inline-block;margin-top:1.5rem;padding:.4rem 1.2rem;
  border-radius:99px;background:#f8fafc;border:1px solid var(--border);
...
th{
  background:#f8fafc;
  padding:1.2rem 1.4rem;text-align:left;font-weight:600;font-size:.85rem;
...
td{
  padding:1.1rem 1.4rem;border-bottom:1px solid var(--border);font-size:.9rem;color:var(--text);
}
tr:last-child td{border-bottom:none}
tr:hover td{background:var(--surface-hover);}

/* Links & Code */
td a{color:var(--accent);text-decoration:none;font-weight:600;transition:all .2s;}
td a:hover{color:var(--accent2);text-decoration:underline;}
td code{
  background:#f1f5f9;padding:.25rem .6rem;border-radius:6px;
  font-family:ui-monospace,monospace;font-size:.85rem;color:#334155;
...
<footer>
  ...
  <a href="https://github.com/hyeonseo2/open-model-license-index" target="_blank">GitHub Repository</a></p>
</footer>
